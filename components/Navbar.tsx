          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <button 
                ...
                className="flex items-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-2.5 rounded-full font-semibold transition-all shadow-lg hover:shadow-emerald-200 transform hover:-translate-y-0.5"
              >
                <UserPlus size={18} />
                ভলান্টিয়ার হোন
              </button>
              ...
              <div className="px-4 pt-2 pb-6 space-y-2 shadow-xl">
                ...
                <div className="pt-4">
                  <button 
                    ...
                    className="w-full flex items-center justify-center gap-2 bg-emerald-600 text-white px-4 py-3 rounded-lg font-semibold"
                  >
                    <UserPlus size={20} />
                    ভলান্টিয়ার হোন
                  </button>
